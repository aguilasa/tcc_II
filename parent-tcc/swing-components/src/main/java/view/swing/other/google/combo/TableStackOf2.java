...
public class TableStackOf2 {
	private Component makeUI() {
		// TEST: UIManager.put("ComboBox.border",
		// BorderFactory.createLineBorder(Color.RED));
		JTable table = new JTable();
		table.setModel(new DefaultTableModel(new Object[][] { { null, null }, { null, null } }, new String[] { "default", "BasicComboBoxUI" }));
			...
			public void updateUI() {
				...
				setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
					...
					protected JButton createArrowButton() {
						JButton b = new JButton(new ArrowIcon2());
...
class ArrowIcon2 implements Icon {
	@Override
