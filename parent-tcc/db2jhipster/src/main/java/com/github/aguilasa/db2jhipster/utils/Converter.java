...
import com.github.aguilasa.db2jhipster.jhipster.FieldType;
import com.github.aguilasa.db2jhipster.metadata.Column;
import com.github.aguilasa.db2jhipster.metadata.ColumnType;
import com.github.aguilasa.db2jhipster.metadata.PrimaryKey;
...
public class Converter {
	...
	static {
		...
		COLUMN_TYPE_FIELD_TYPES_MAP.put(ColumnType.VARBINARY, FieldType.BLOB);
		...
		COLUMN_TYPE_FIELD_TYPES_MAP.put(ColumnType.TIMESTAMP_TZ, FieldType.ZONEDDATETIME);
		...
		COLUMN_TYPE_FIELD_TYPES_MAP.put(ColumnType.SQLXML, FieldType.TEXTBLOB);
		...
		COLUMN_TYPE_FIELD_TYPES_MAP.put(ColumnType.FLOAT, FieldType.FLOAT);
	}
